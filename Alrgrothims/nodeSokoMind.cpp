...
//
//	//BOTTOM CHECK
//	if (*(inputNode->robotIterator + inputNode->width) != 'O') {//if going in we know there is no wall down
//		switch (inputNode->BoxChecker(inputNode->robotIterator, 1)) {
//		case 1: {//down legal move with box
//			int newDistance = (inputNode->distance + inputNode->width);
//			NodeSokoMind* newNode = new NodeSokoMind(inputNode);
//			*newNode->robotIterator = 32; //set the current posistion to empty space
//			inputNode->CreateNewBoard(inputNode, newNode, (newNode->robotIterator + inputNode->width), ((newNode->robotIterator) + (inputNode->width * 2)), newDistance);
//			break;
//		}
...
//			NodeSokoMind* newNode = new NodeSokoMind(inputNode);
//			*newNode->robotIterator = 32; //set the current posistion to empty space
//			inputNode->CreateNewBoard(inputNode, newNode, (newNode->robotIterator + inputNode->width), newDistance);
//		}
...
//
//	//TOP CHECK
//	if (*(inputNode->robotIterator - inputNode->width) != 'O') {//if going in we know there is no wall left
//		switch (inputNode->BoxChecker(inputNode->robotIterator, 2)) {
...
//		switch (inputNode->BoxChecker(inputNode->robotIterator, 3)) {
//		case 3: {//left legal move with box
//			int newDistance = (inputNode->distance - 1);
//			NodeSokoMind* newNode = new NodeSokoMind(inputNode);
//			*newNode->robotIterator = 32; //set the current posistion to empty space
//			inputNode->CreateNewBoard(inputNode, newNode, ((newNode->robotIterator) - 1), ((newNode->robotIterator) - 2), newDistance);
//			break;
//		}
...
//			NodeSokoMind* newNode = new NodeSokoMind(inputNode);
//			*newNode->robotIterator = 32; //set the current posistion to empty space
//			inputNode->CreateNewBoard(inputNode, newNode, (newNode->robotIterator - 1), newDistance);
//			break;
//		}
//		case -1: //another box is in direction of push
//			break;
...
//	//RIGHT CHECK
//	if (*(inputNode->robotIterator + 1) != 'O') {//if going in we know there is no wall left
//		switch (inputNode->BoxChecker(inputNode->robotIterator, 4)) {
